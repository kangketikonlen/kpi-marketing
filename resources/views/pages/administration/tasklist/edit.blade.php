@php
    $html_tag_data = [];
    $title = 'Formulir Edit Penugasan';
    $description = 'Edit Penugasan';
    $url = '/administration/tasklist/' . $tasklist->id;
                ...
                <div class="row g-3 mb-3">
                    <div class="col">
                        <div class="w-100">
                            ...
                            <select class="form-control" autocomplete="off" id="indicator" name="indicator">
                                <option></option>
                                <option value="Sales" {{ $tasklist->indicator == 'Sales' ? 'selected' : '' }}>
                                    Sales
                                </option>
                                <option value="Report" {{ $tasklist->indicator == 'Report' ? 'selected' : '' }}>
                                    Report
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col">
                        <div class="w-100">
                            ...
                            <select class="form-control" autocomplete="off" id="employee_id" name="employee_id">
                                <option value="{{ $tasklist->employee_id }}">
                                    {{ $tasklist->employee->fullname }}
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="w-100">
                            ...
                            <input type="date" class="form-control" autocomplete="off" id="actual_date"
                                name="actual_date" value="{{ $tasklist->actual_date }}">
                        </div>
                    </div>
                </div>
            </div>

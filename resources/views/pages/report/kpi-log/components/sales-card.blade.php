<div class="card mb-5">
    <div class="card-header pt-2 pb-2">
        <h4 class="fw-bold m-0">Sales KPI</h4>
    </div>
                ...
                @else
                    @foreach ($performances as $data)
                        <tr>
                            ...
                            <td class="align-middle text-end">{{ number_format($data['sales_target']) }}</td>
                            <td class="align-middle text-end">{{ number_format($data['sales_actual_target']) }}</td>
                            <td class="align-middle text-end">{{ number_format($data['sales_achivement']) }}%</td>
                            <td class="align-middle text-end">{{ number_format($data['sales_weight']) }}%</td>
                            <td class="align-middle text-end">{{ number_format($data['sales_late']) }}%</td>
                            <td class="align-middle text-end">{{ number_format($data['sales_weight_total']) }}%</td>
                        </tr>
                    @endforeach
                @endif
            </tbody>
